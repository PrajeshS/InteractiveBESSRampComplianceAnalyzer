...
pv_signal = load_data()
export, bess, soc, v_count, d_mins, d_stats, a_solar, a_export, a_curtail = run_sim(pv_signal, pwr_cap, enr_cap, soc_min, soc_max, selected_day, init_soc_pct)
...
c3.metric('Annual BESS MWh', f'{np.sum(np.abs(bess))/60:,.0f}')
