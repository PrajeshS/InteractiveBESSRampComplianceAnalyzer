...
st.markdown("""
    ...
    /* Standardize all numeric inputs to use the dark stepper style */
...
# Fixed to number_input for UI consistency (plus/minus buttons)
...
# Compliance threshold moved directly to sidebar (no expander)
...
event_notes = {
    ...
    13: "<b>Highest Solar Generation:</b> Peak production day. Tests BESS saturation risks.",
    358: "<b>Lowest Solar Generation:</b> Deep winter scenario. Verifies behavior during low-output periods."
}
